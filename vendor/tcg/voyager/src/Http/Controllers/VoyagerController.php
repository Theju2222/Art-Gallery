...

{
...

    {
        ...
        $order_count = Order::orderBy('id', 'DESC')->count();
        $enqueries = Order::orderBy('id', 'DESC')->paginate(10);
        $enqueries->order_count = $order_count; 
        ...
        return Voyager::view('voyager::index', ['users' => $users, 'enqueries' => $enqueries, 'products' => $products]);
