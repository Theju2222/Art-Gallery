...
<main role="main" class="col-md-12 ml-sm-auto col-lg-12 my-3" style="margin-top:60px;">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                ...
                <div class="card green">
                    ...
                    <div class="stat"><b><a href="admin/customers" style="color:#fff;">View</a></b></div>
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                ...
                <div class="card red">
                    ...
                    <div class="value">{{$enqueries->order_count}}</div>

                    <div class="stat"><b><a href="admin/orders" style="color:#fff;">View</a></b></div>
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                ...
                <div class="card orange">
                    ...
                    <div class="stat"><b><a href="admin/products" style="color:#fff;">View</a></b></div>
    ...
    <div class="projects mb-4">
        ...
        <div class="projects-inner">
            ...
            <header class="projects-header">
                ...
                <div class="count">| {{$enqueries->count()}}</div>
            ...
            <table class="projects-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($order->status == 0)
                        <p class="label label-danger">Canceled</p> 
                        @elseif($order->status == 2)
                        <p class="label label-primary">Done</p>
                        @else 
                        <p class="label label-warning">Processing</p>
                        @endif
                    ...
                    <td>
                        ...
                        <p class="label label-danger">pending</p> 
                        @else
                        <p class="label label-primary">done</p> 
                        @endif
                    </td>
                    ...
                    <td >
                       ...
                       <p><i class="fa fa-user"></i>&nbsp;&nbsp; {{$order->customer->name}}</p>

                    </td>

                    <td class="status text-center">

                        <a href="admin/orders/{{$order->id}}/edit" style="color:#fff;">View</a>
